...
def insert_db(db, tx_id, type, time, _from, to, amount, property_name, valid, property_id):
    ...
    # SQL 插入语句
    sql = "INSERT INTO omni_explorer_1A VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}') on duplicate key update tx_id = values(tx_id)".format(
...
# 获取页数
def get_pages():
    data = {'addr': '1ApkXfxWgJ5CBHzrogVSKz23umMZ32wvNA'}
    try:
