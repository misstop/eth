...
def insert_db(db, tx_id, type, time, _from, to, amount, property_name, valid, property_id):
    ...
    # SQL 插入语句
    sql = "INSERT INTO omni_explorer_16 VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}') on duplicate key update tx_id = values(tx_id)".format(
...
# 获取页数
def get_pages():
    data = {'addr': '168o1kqNquEJeR9vosUB5fw4eAwcVAgh8P'}
    try:
